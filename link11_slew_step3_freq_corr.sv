module link11_slew_step3_freq_corr #(
    ...
    input wire [LPF_WIDTH-1:0] ram_cache_out_i, ram_cache_out_q,
    input wire [15:0] phase_corr_dds_i, phase_corr_dds_q,
    output wire [LPF_WIDTH-1:0] freq_corrected_i, freq_corrected_q,
...
wire [LPF_WIDTH-1:0] mixer_out_i, mixer_out_q;
assign mixer_out_i = oi[MIXER_OUT_WIDTH-1-:LPF_WIDTH];
assign mixer_out_q = oq[MIXER_OUT_WIDTH-1-:LPF_WIDTH];
